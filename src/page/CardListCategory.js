...
const CardListCategory = ({ id, image, title, category, synopsis, movie }) => {
	...
	return (
		<div>
			<div className="flex m-auto w-80 h-full movie transform hover:scale-105 ease-in-out duration-500">
